...
class Directory(models.Model):
    ...
    owner = models.ForeignKey('Profile', verbose_name='拥有者',on_delete=models.CASCADE)
...
class Goods(models.Model):
    ...
    belong = models.ForeignKey('Directory', verbose_name='商品归属库', default=None,on_delete=models.CASCADE)
...
class Log(models.Model):
    ...
    owner = models.ForeignKey('Profile', verbose_name='日志所属人', default=None,on_delete=models.CASCADE)
    ...
    # 建库
    dir = models.ForeignKey('Directory', verbose_name='所建库', blank=True, null=True,on_delete=models.CASCADE)

    # 出入库
    good = models.ForeignKey('Goods', verbose_name='操作商品', blank=True, null=True,on_delete=models.CASCADE)
